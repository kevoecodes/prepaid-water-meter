...
from Users_Management.MongoCRUD import MongoCheck, MongoGetUserData
from .MongoCRUD import MongoCreateUser
...
class RegisterUser(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            if User.objects.filter(username=user["mobileNo"]).exists() or User.objects.filter(first_name=user["full_name"]).exists():
                feed = {
                    "iscreated": False,
